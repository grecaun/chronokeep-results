...
func (s *SQLite) GetEventYear(event_slug, year string) (*types.EventYear, error) {
	db, err := s.GetDB()
	if err != nil {
		return nil, err
	}
...
func (s *SQLite) GetAllEventYears() ([]types.EventYear, error) {
	db, err := s.GetDB()
	if err != nil {
		return nil, err
	}
...
func (s *SQLite) AddEventYear(year types.EventYear) (*types.EventYear, error) {
	db, err := s.GetDB()
	if err != nil {
		return nil, err
	}
...
func (s *SQLite) DeleteEventYear(year types.EventYear) error {
	db, err := s.GetDB()
	if err != nil {
		return err
	}
...
func (s *SQLite) UpdateEventYear(year types.EventYear) error {
	db, err := s.GetDB()
	if err != nil {
		return err
	}
