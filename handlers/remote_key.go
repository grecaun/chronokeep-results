...
func (h Handler) GetRemoteKeys(c echo.Context) error {
	return nil
	/*
...
func (h Handler) AddRemoteKey(c echo.Context) error {
	return nil
	/*
...
func (h Handler) DeleteRemoteKey(c echo.Context) error {
	return nil
	/*
...
func (h Handler) UpdateRemoteKey(c echo.Context) error {
	return nil
	/*
